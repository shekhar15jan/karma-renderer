...
exports.estimateNodeSize = void 0;
exports.shapeColors = shapeColors;
exports.shapeSizes = shapeSizes;
exports.renderShape = renderShape;
const icons_1 = require("../icons/icons");
const layout_1 = require("../layout/layout");
Object.defineProperty(exports, "estimateNodeSize", { enumerable: true, get: function () { return layout_1.estimateNodeSize; } });
...
function shapeSizes(c, defaultW, defaultH) {
...
function labelMarkup(label, maxChars, fontSize, fill, centerX, centerY, weight = "bold", lineHeight = 1.25) {
    if (!label)
        return "";
...
function renderShape(c, ctx) {
    ...
    switch (type) {
        ...
        case "class": {
            ...
            const attrs = c.data?.attributes ?? c.data?.fields ?? [];
    ...
    if ((type === "box" || type === "rect") && c.icon) {
        ...
        iconMarkup = `<g transform="translate(${hasLabel ? 22 : cx - iconSize / 2}, ${cy - iconSize / 2})">${(0, icons_1.iconSvg)(c.icon, iconSize, "shape-icon")}</g>`;
